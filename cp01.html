...
<head>
  ...
  <title>エクササイズチャレンジキャンペーン開催！</title>
    ...
    <div class="l-lpContent">
      <div class="l-lpContainer">
        <div class="l-lpHeroSection">
          <span class="l-lpHeroSection_label --purple"><img class="l-lpHeroSection_label_text" src="./assets/img/cp01/vip_limited.png" alt="VIP限定!"></span>
          <h1 class="l-lpHeroSection_title --purple"><img src="./assets/img/cp01/lp_title.png" alt="エクササイズチャレンジキャンペーン開催！"></h1>
          <p class="l-lpHeroSection_text">
            いつもプレイありがとうございます！<br>
            サブスク継続会員の皆さま向けビューティージムVIP限定の<br>
            アップデートキャンペーンが始まります。
          </p>
          <div class="l-lpHeroSection_period --purple">
        ...
        <div class="l-lpChallenge_grid">
          <figure class="l-lpChallenge_character">
            <img src="./assets/img/cp01/illust_girl.png" alt="小鳥遊ルイ">
          </figure>
          <div class="l-lpChallenge_detail">
            <img class="l-lpChallenge_detail_bg" src="./assets/img/cp01/bubble_left.png" alt="">
            <h2 class="l-lpBubble_title l-lpChallenge_detail_title"><img src="./assets/img/cp01/challenge_title.png" alt="5秒クイズチャレンジ!"></h2>
            <p class="l-lpBubble_text l-lpChallenge_detail_text">
              超かんたん！<br>
              5秒3択クイズを10問答えてクイズに正解すると…
            </p>
            <p class="l-lpBubble_highlight l-lpChallenge_detail_highlight --purple">
              豪華プレゼント抽選に応募！<br>
              抽選でスペシャル賞品が当たります！
            </p>
        ...
        <div class="l-lpPresent_grid">
          ...
          <div class="l-lpPresent_detail">
            <img class="l-lpPresent_detail_bg" src="./assets/img/cp01/bubble_right.png" alt="">
            <h2 class="l-lpBubble_title l-lpPresent_detail_title"><img src="./assets/img/cp01/present_title.png" alt="回答者全員プレゼント！"></h2>
            <p class="l-lpBubble_text l-lpPresent_detail_text">
              クイズに回答してくれたプレイヤー全員に
            </p>
            <p class="l-lpBubble_highlight l-lpPresent_detail_highlight --purple">
              「住人たちのスマホ壁紙」を<br>
              &nbsp;&nbsp;プレゼント！<br>
              &nbsp;&nbsp;ここでしか手に入らない<br>
              &nbsp;&nbsp;限定デザインです！
        ...
        <!-- present section -->
        <a class="js-cta_button l-lpCta_button --purple" href="">
          <img src="./assets/img/cp01/quiz_start.png" alt="クイズを始める">
        </a>
        <!-- cta button -->
      </div>
    </div>
